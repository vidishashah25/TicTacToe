...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("MainActivicty","onCreate");
        initializeBoard();
    }

    private void initializeBoard(){

        Log.d("MainActivicty","initializeboard");
    ...
    private void checkWinner(){
        //raws
        Log.d("MainActivicty","checkWinner");
    ...
    private  void  setInfo(String s){
        ...
        Log.d("MainActivicty","setInfo");
    }

    private void enableallButton(Boolean value){
        ...
        Log.d("MainActivicty","enableallbutton");
    }
    ...
    private void resetButton(){
        ...
        Log.d("MainActivicty","resetbutton");
